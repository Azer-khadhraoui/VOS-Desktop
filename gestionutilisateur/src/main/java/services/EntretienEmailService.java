...
public class EntretienEmailService {
    ...
    // ========== CONFIGURATION GMAIL ==========
    private static final String FROM_EMAIL    = "mamiyassine313@gmail.com";
    private static final String FROM_PASSWORD = "vkvpfsedpeyzvmyc"; // Voir instructions ci-dessous

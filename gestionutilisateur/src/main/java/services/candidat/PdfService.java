...
public class PdfService {
    ...
    private void addInfosCandidat(Document document, Candidature candidature) {
        ...
        if (user != null) {
            addTableRow(table, "Nom :", user.getNom() != null ? user.getNom() : "Non disponible");
            addTableRow(table, "Prénom :", user.getPrenom() != null ? user.getPrenom() : "Non disponible");
            addTableRow(table, "Email :", user.getEmail() != null ? user.getEmail() : "Non disponible");
        } else {
            addTableRow(table, "Nom :", "Non disponible");
            addTableRow(table, "Prénom :", "Non disponible");
            addTableRow(table, "Email :", "Non disponible");
            System.out.println("⚠️ Aucun utilisateur connecté dans UserSession");
        }

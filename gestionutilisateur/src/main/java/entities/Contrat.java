...
public class Contrat {
    ...
    private String user_name; // New field for identifying the user

    public Contrat() {
    }

    public Contrat(String type_contrat, Date date_debut, Date date_fin, double salaire, String status,
            String volume_horaire, String avantages, int id_recrutement, String user_name) {
    ...
    public Contrat(int id_contrat, String type_contrat, Date date_debut, Date date_fin, double salaire, String status,
            String volume_horaire, String avantages, int id_recrutement, String user_name) {

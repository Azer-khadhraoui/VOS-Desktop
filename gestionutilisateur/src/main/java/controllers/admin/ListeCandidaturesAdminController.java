...
public class ListeCandidaturesAdminController implements Initializable {
    ...
    @FXML
    private Label lblAcceptee;
    @FXML
    private Label lblRefusee;
    @FXML
    private Label lblNbResultats;
    @FXML
    ...
    @FXML
    private TableColumn<Candidature, String> colStatut;
    @FXML
    private TableColumn<Candidature, String> colNiveauExp;
    @FXML
    private TableColumn<Candidature, Integer> colAnneesExp;
    @FXML
    private TableColumn<Candidature, String> colDomaine;
    @FXML
    private TableColumn<Candidature, String> colDernierPoste;
    @FXML
    private TableColumn<Candidature, Integer> colIdUtilisateur;
    @FXML
    private TableColumn<Candidature, Integer> colIdOffre;
    @FXML
    private TableColumn<Candidature, Void> colActions;
    ...
    @FXML
    private Button btnVoirPreferences;  // Ajouter cette ligne après les autres @FXML
    ...
    private void configurerColonnes() {
        ...
        colActions.setCellFactory(col -> new TableCell<>() {
...

            {
                ...
                // Edit button styling
                btnModifier.setStyle("-fx-background-color: #e0e7ff; -fx-background-radius: 8; -fx-cursor: hand; -fx-padding: 8 10; -fx-min-width: 36; -fx-min-height: 36; -fx-border-width: 0;");

                // Edit button hover effect
                btnModifier.setOnMouseEntered(e -> btnModifier.setStyle("-fx-background-color: #c7d2fe; -fx-background-radius: 8; -fx-cursor: hand; -fx-padding: 8 10; -fx-min-width: 36; -fx-min-height: 36; -fx-border-width: 0;"));
                btnModifier.setOnMouseExited(e -> btnModifier.setStyle("-fx-background-color: #e0e7ff; -fx-background-radius: 8; -fx-cursor: hand; -fx-padding: 8 10; -fx-min-width: 36; -fx-min-height: 36; -fx-border-width: 0;"));

                // Delete button styling
                btnSupprimer.setStyle("-fx-background-color: #fee2e2; -fx-background-radius: 8; -fx-cursor: hand; -fx-padding: 8 10; -fx-min-width: 36; -fx-min-height: 36; -fx-border-width: 0;");

                // Delete button hover effect
                btnSupprimer.setOnMouseEntered(e -> btnSupprimer.setStyle("-fx-background-color: #fecaca; -fx-background-radius: 8; -fx-cursor: hand; -fx-padding: 8 10; -fx-min-width: 36; -fx-min-height: 36; -fx-border-width: 0;"));
                btnSupprimer.setOnMouseExited(e -> btnSupprimer.setStyle("-fx-background-color: #fee2e2; -fx-background-radius: 8; -fx-cursor: hand; -fx-padding: 8 10; -fx-min-width: 36; -fx-min-height: 36; -fx-border-width: 0;"));
    ...
    /* ===================== UTILITAIRES ===================== */
    /**
     * Appelé par FormCandidatureAdminController après sauvegarde pour
     * rafraîchir
     */

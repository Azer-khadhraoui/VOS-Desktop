...
public class ProfilController {
    ...
    public void retournerOffres() {
        try {
            String target = "/fxml/admin/AdminView.fxml";
            Utilisateur currentUser = UserSession.getInstance().getCurrentUser();
            if (currentUser != null && "CLIENT".equalsIgnoreCase(currentUser.getRole())) {
                target = "/fxml/utilisateur/MainView.fxml";
            }
            ...
            e.printStackTrace();
            showError("Erreur", "Impossible de retourner a la page precedente");
        }
    }

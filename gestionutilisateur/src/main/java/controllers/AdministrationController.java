...
public class AdministrationController {
    ...
    @FXML
    public void goToGestionEntretien() {
        try {
            ...
            Scene newScene = new Scene(root, 1440, 1024);
            stage.setScene(newScene);
            stage.setTitle("Gestion des Entretiens - VOS Admin");
            stage.centerOnScreen();
            System.out.println("✓ Navigation vers Gestion des Entretiens");
        } catch (Exception e) {
            e.printStackTrace();
            Alert alert = new Alert(Alert.AlertType.ERROR);
            alert.setTitle("Erreur");
            alert.setContentText("Impossible d'ouvrir la gestion des entretiens: " + e.getMessage());
            alert.showAndWait();
        }
    }

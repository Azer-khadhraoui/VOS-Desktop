...
public class FormPreferenceUtilisateurController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        if (userConnecte != null) {
            ...
            System.out.println("✅ FormPreference - Utilisateur connecté : ID=" + idUtilisateurCourant);
        } else {
            System.out.println("❌ FormPreference - Aucun utilisateur connecté !");
            idUtilisateurCourant = 0; // Valeur par défaut
        }
    }
    ...
    private PreferenceCandidature construirePreference() {
        ...
        p.setIdUtilisateur(idUtilisateurCourant);

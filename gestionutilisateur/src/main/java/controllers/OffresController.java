    ...
    private void showProfile() {
        try {
            ...
            if (currentUser == null) {
                ...
                alert.setContentText("Aucun utilisateur connecté. Veuillez vous reconnecter.");
                alert.showAndWait();
                return;
            }
            
            // Navigate to ProfilView
            javafx.fxml.FXMLLoader loader = new javafx.fxml.FXMLLoader(getClass().getResource("/ProfilView.fxml"));
            javafx.scene.Parent root = loader.load();
            
            // ProfilController automatically loads user from UserSession in initialize()
            ...
            System.out.println("✓ Navigation vers profil utilisateur (ProfilView)");
            ...
            alert.setContentText("Impossible d'afficher le profil : " + e.getMessage());
            alert.showAndWait();
        }
    }
